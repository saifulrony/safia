...
class ProBuilder_Notification_Widget extends ProBuilder_Base_Widget {
    ...
    protected function render() {
        ...
        $id = 'notif-' . uniqid();
        echo '<div id="' . $id . '" class="pb-notification type-' . $s['type'] . '" style="position:fixed;' . $s['position'] . ':0;left:0;right:0;background:' . $colors[$s['type']] . ';color:#fff;padding:15px;text-align:center;z-index:99999">';
