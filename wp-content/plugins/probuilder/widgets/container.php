<?php
/**
 * Container Widget - Based on Grid Layout with Perfect Resize
...
class ProBuilder_Widget_Container extends ProBuilder_Base_Widget {
    ...
    protected function render() {
        ...
        $grid_id = 'probuilder-container-' . uniqid();
        ...
        <style>
            ...
            #<?php echo $grid_id; ?> .container-cell {
            ...
            #<?php echo $grid_id; ?> .container-cell .resize-handle {
                position: absolute;
                background: #007cba;
                opacity: 0;
            ...
            #<?php echo $grid_id; ?> .container-cell:hover .resize-handle {
                opacity: 0.6;
            }
            
            #<?php echo $grid_id; ?> .container-cell .resize-handle:hover {
                opacity: 1 !important;
            }
            
            #<?php echo $grid_id; ?> .container-cell .resize-handle-right {
                top: 0;
                right: 0;
                width: 4px;
                height: 100%;
            ...
            #<?php echo $grid_id; ?> .container-cell .resize-handle-bottom {
                bottom: 0;
                left: 0;
                width: 100%;
                height: 4px;
            ...
            #<?php echo $grid_id; ?> .container-cell .resize-handle-corner {
                bottom: 0;
                right: 0;
                width: 12px;
                height: 12px;
            ...
            #<?php echo $grid_id; ?> .container-cell-<?php echo $index + 1; ?> {
                grid-area: <?php echo esc_attr($area); ?>;
            }
            <?php endforeach; ?>
            
            #<?php echo $grid_id; ?> .container-cell-content {
                width: 100%;
                height: 100%;
                display: flex;
                align-items: center;
            ...
            #<?php echo $grid_id; ?> .container-cell:hover .container-cell-toolbar {
                opacity: 1;
            }
            
            #<?php echo $grid_id; ?> .container-cell-toolbar button {
                background: #007cba;
                color: white;
                border: none;
                border-radius: 3px;
            ...
            #<?php echo $grid_id; ?> .container-cell-toolbar button:hover {
                background: #005a87;
            }
        </style>
            ...
            ?>
                <div class="container-cell container-cell-<?php echo $i + 1; ?>" data-cell-index="<?php echo $i; ?>">
                    ...
                    <div class="container-cell-toolbar">
                        ...
                        <button class="settings-btn" title="Column Settings">
                    ...
                    <div class="container-cell-content">
                        ...
                        if (!empty($children) && isset($children[$i])) {
                            ...
                            if ($child_widget) {
                                $child_widget->render_widget($child['settings'] ?? []);
                            }
                        } else {
                            ...
                            if (isset($_GET['probuilder']) && $_GET['probuilder'] === 'true') {
                                ...
                                <div style="font-size: 12px; margin-top: 8px; color: #999;">Column <?php echo $i + 1; ?></div>
                                <div style="font-size: 11px; margin-top: 4px; color: #bbb;">Drop widgets here</div>
                                <?php
                            }
                            // On frontend: show nothing (empty column)
                        }
                        ?>
                    </div>
                </div>
