...
class ProBuilder_Portfolio_Widget extends ProBuilder_Base_Widget {
    ...
    protected function render() {
        ...
        echo '<div style="display:grid;grid-template-columns:repeat(' . ($inline_styles ? ' ' . $inline_styles : '') . '' . $columns . ',1fr);gap:20px">';
        ...
        foreach ($items as $item) {
            ...
            echo '<div class="' . esc_attr($wrapper_classes) . ' overlay" style="position:absolute;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.8);display:flex;align-items:center;justify-content:center;flex-direction:column;color:#fff;opacity:0;transition:opacity 0.3s">';
